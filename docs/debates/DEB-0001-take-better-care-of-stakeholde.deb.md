...
```markdown
# DEB-0001: take better care of stakeholders
...
take better care of stakeholders: What is the core question we need to answer?
...
- docs/debates/DEB-0001-this-is-weird.deb.md:37
  > ## Stakeholders
...
```argdown
take better care of stakeholders: The main question being debated
